...
console.log("MVR - appending options");
console.log(options.length);
	    //for (var i in options)
	    for (var i = 0; i < options.length; i++)
	    {
console.log(i);
console.log("MVR - appending options inside 1");
		var val = options[i];
console.log("MVR - appending options inside 2");
		x.appendChild(val);
console.log("MVR - appending options inside 3");
	    }
console.log("MVR - done appending options");
